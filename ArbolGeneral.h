...
/**
  ...
  */
  ...
  private:
    ...
    /**
      * @brief Devuelve la altura en la que se encuentra el nodo
      * @param n es un puntero que apunta a un nodo concreto
      * @return devuelve un entero con la altura del nodo.
      */
  ...
  public:
    ...
    class iter_preorden{
	 ...
	 int level; ///< altura del nodo
       public:
	 /**
	   * @brief Devuelve el el atributo privado it
	   */
	 Nodo iterador(){
	 	return it;
	 }
	...
	iter_preorden();
	 ...
	 Tbase & operator*();
	 /**
	   * @brief método que devuelve si el iterado actual es un nodo Hoja.
	   */
	 bool Hoja(){
    return it->izqda==0;
   }
   ...
   /**
   	 * @brief metodo que devuelve el nodo al que apunta el atributo privado it
   	 */
   Nodo& GetNodo(){
    return it;
   }
